...
import Corona1 from './assets/corona1.jpeg'
import Corona2 from './assets/corona2.jpeg'
import Corona3 from './assets/corona3.jpg'
import Corona4 from './assets/corona4.jpeg'
            ...
            {docs && docs.map(doc => (
                    <Card style={{ width: '22rem' }} className='box'>
                        <Card.Img variant="top" src={doc.image}className='boximg'/>
                            ...
                            <Button variant="primary" href={doc.link}>More Information</Button>
                        </Card.Body>
                    </Card>
